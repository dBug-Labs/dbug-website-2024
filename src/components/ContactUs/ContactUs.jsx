  ...
  return (
    <div className="bg-black text-white font-light place-content-center my-12 md:mx-10 lg:mx-24">
      <div className='lg:grid lg:grid-cols-2 lg:gap-x-48 lg:place-items-center ml-[42px] text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]'>
        ...
        <div className=''>
          <div className='text-[9px] mr-5 sm:text-[12px] md:text-[15px]'>
            <div className='grid grid-cols-2 grid-rows-1 gap place-content-center mb-8 lg:grid-cols-1 lg:grid-rows-4 lg:gap-y-8'>
              <div className="flex flex-row items-start flex-1 w-25 sm:max-w-60 md:max-w-64 lg:min-w-72">
                <div className="mt-0.5">
                  <img src="AssetsContactUs\Globe.svg" alt="Globe" className="w-10 min-[375px]:w-[30px] sm:w-8 md:w-10" />
                </div>
                <div className='pl-2'>
                  <div className="flex items-center">
                    <a href="https://dbuglabs.com" target='_self' className="text-white font-bold hover:underline flex flex-row">dbuglabs.com&nbsp;<img className='w-1.5 mb-1' src="AssetsContactUs\link-arrow.svg" alt="Link" /> </a>
                  </div>
              ...
              <div className="flex flex-row items-start flex-1 w-25 sm:max-w-60 md:max-w-64">
                <div className="mt-0.5">
                  <img src="AssetsContactUs\Insta.svg" alt="Instagram" className="w-7 min-[375px]:w-[20px] sm:w-4.5 md:w-7" />
                </div>
                <div className='pl-2'>
                  <div className="flex items-center">
                    <a href="https://www.instagram.com/dbuglabs/" target='_blank' className="text-white font-bold hover:underline flex flex-row">@dbuglabs&nbsp;<img className='w-1.5 mb-1' src="AssetsContactUs\link-arrow.svg" alt="Link" /> </a>
                  </div>
              ...
              <div className="flex flex-row items-start flex-1 w-25 mt-5 lg:mt-0 sm:max-w-60">
                <div className="mt-0.5">
                  <img src="AssetsContactUs\Mail.svg" alt="Mail" className="w-10 min-[375px]:w-[30px] sm:w-7 md:w-10" />
                </div>
                <div className='pl-2'>
                  <div className="flex items-center">
                  <a href="mailto:hello@dbuglabs.com" className="text-white font-bold hover:underline flex flex-row">hello@dbuglabs.com&nbsp;<img className='w-1.5 mb-1' src="AssetsContactUs\link-arrow.svg" alt="Link" /> </a>                  </div>
              ...
              <div className="flex flex-row items-start flex-1 w-25 mt-5 lg:mt-0 sm:max-w-60">
                <div className="mt-0.5">
                  <img src="AssetsContactUs\LinkedIn.svg" alt="LinkedIn" className="w-10 min-[375px]:w-[30px] sm:w-7 md:w-10" />
                </div>
                <div className='pl-2'>
                  <div className="flex items-center">
                    <a href="https://www.linkedin.com/company/dbug-labs" target='_blank'  className="text-white font-bold hover:underline flex flex-row">@Dbug Labs&nbsp;<img className='w-1.5 mb-1' src="AssetsContactUs\link-arrow.svg" alt="Link" /> </a>
                  </div>
